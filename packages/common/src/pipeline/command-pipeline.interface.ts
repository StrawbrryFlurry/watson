import { Prefix } from '@common/command/common/prefix.interface';
import { MessageMatchResult } from '@common/command/matcher';
import { CommandAst } from '@common/command/parsing/ast.interface';
import { CommandRoute } from '@common/router';
import {
  DMChannel,
  Guild,
  GuildMember,
